...
private:
    ...
    vector<Food> foods = {
        ...
        Food(U"오징어", 0, U"고양이가 생 오징어나 새우, 회 같은 날음식을 많이 먹게 되면 \n비타민 B1(티아민) 결핍이 올 수도 있어요. \n그 이유는 생선에 티아민 성분을 없애버리는 티아미나아제(thiaminase) 효소가 들어있기 때문인데요. \n만약 고양이가 비타민B1 결핍에 걸리게 된다면, 신경학적 문제가 일어나 경련을 일으키거나 호흡 곤란으로 사망할 수도 있습니다.", 5),
